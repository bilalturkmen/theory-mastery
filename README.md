...
- **State Management for Large Quizzes:** Managed a complex state (answers, bookmarks, timers) across multiple views using `Context`, `useReducer` and `useMemo` to ensure the app remained performant even with 50+ questions.
